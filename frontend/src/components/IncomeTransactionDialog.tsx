...
type IncomeTransactionForm = z.infer<typeof incomeTransactionSchema>
...
export default function IncomeTransactionDialog({
  open,
  onClose,
  onSuccess,
  transaction,
    ...
    <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <DialogActions sx={{ bgcolor: '#1E293B' }}>
          ...
          >
            {loading ? 'Guardando...' : transaction ? 'Actualizar' : 'Crear Ingreso'}
          </Button>
        </DialogActions>
      </form>
    </Dialog>
